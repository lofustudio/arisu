...
module.exports = {
    ...
    async execute(interaction) {
        ...
        let options_amount = interaction.options.getInteger('amount');
        let options_time = interaction.options.getString('time');
        ...
        if (time > 2592000000) time = 315569520000; // 10 years
        if (time < 5000) time = 5000; // 5 seconds
